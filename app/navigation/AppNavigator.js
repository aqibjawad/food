...
import RecomendationNavigator from './RecomendationNavigator';
...
const AppNavigator = () => {
    ...
    return (
        <Tab.Navigator initialRouteName="Feed" >
            ...
            <Tab.Screen
                options={{
                    tabBarIcon: ({ color, size }) => <MaterialCommunityIcons color={color} size={size} name="recomendation" />
                }}
                name="Recomendation" component={RecomendationNavigator} />

            {/* <Tab.Screen
                options={{
                    tabBarIcon: ({ color, size }) => <MaterialCommunityIcons color={color} size={size} name="test" />
                }}
                name="Test Screen" component={TestNavigator} /> */}
        </Tab.Navigator>
    )
}
